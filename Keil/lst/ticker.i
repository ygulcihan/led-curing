...
#line 2 "..\\Library\\Sinyalizasyon\\src\\ticker.c"
...
void TMR0_IRQHandler(void)
{
	...
	((TIMER_T *) (((uint32_t)0x40000000) + 0x10000))->TISR = (1ul << 0);
}
...
void startTicker(TIMER_T *timer)
{
	...
	if (!((timer)->TCSR & (1ul << 25) ? 1 : 0))
	{
		if (timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x10000)))
			((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK |= (1ul << 2);
		if (timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x10020)))
			((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK |= (1ul << 3);
	}
	...
	timer->TCMPR = (22118400 / compareDivider);
	timer->TCSR = (1ul << 30) | (1ul << 29) | (1UL << 27) | (prescaler);
