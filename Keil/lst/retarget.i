...
#line 158 "..\\Library\\StdDriver\\src\\retarget.c"
...
#line 339 "..\\Library\\StdDriver\\src\\retarget.c"
...
#line 427 "..\\Library\\StdDriver\\src\\retarget.c"
        while (1){
            if(!(((UART_T *) (((uint32_t)0x40000000) + 0x50000))->FSR & (1ul << 14)))
            {
...
int kbhit(void)
{
    ...
    return !(((UART_T *) (((uint32_t)0x40000000) + 0x50000))->FSR & (1ul << 14));
...
int IsDebugFifoEmpty(void)
{
    ...
    return (((UART_T *) (((uint32_t)0x40000000) + 0x50000))->FSR & (1ul << 28)) ? 1 : 0;
...
#line 517 "..\\Library\\StdDriver\\src\\retarget.c"
int fgetc(FILE *f) {
    return (GetChar());
}
...
#line 542 "..\\Library\\StdDriver\\src\\retarget.c"
