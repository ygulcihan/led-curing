...
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->RSTSRC |= u32Src;
}
...
uint32_t SYS_GetBODStatus(void)
{
    return (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & (1ul << 6))?1:0;
}
...
uint32_t SYS_GetResetSrc(void)
{
    return (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->RSTSRC);
}
...
void SYS_ResetCPU(void)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC1 |= (1ul << 1);
}
...
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
    *(volatile uint32_t *)(&(((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC1) + (u32ModuleIndex>>24)) |= 1<<(u32ModuleIndex & 0x00ffffff);
    *(volatile uint32_t *)(&(((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC1) + (u32ModuleIndex>>24)) &= ~(1<<(u32ModuleIndex & 0x00ffffff));
}
...
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL |= (1ul << 0);
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~(1ul << 3)) | i32Mode;
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~(3ul << 1)) | u32BODLevel;
}
...
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL &= ~(1ul << 0);
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~(3ul << 1)) | (3UL<<1) ;
}
