                                  ...
                                  uint32_t u32DutyCycle)
{
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PPR = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PPR & ~((0xFFul << 0) << ((u32ChannelNum >> 1) * 8))) | (u8Prescale << ((u32ChannelNum >> 1) * 8));
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CSR = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CSR & ~((7ul << 0) << (4 * u32ChannelNum))) | (u8Divider << (4 * u32ChannelNum));
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PCR = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PCR & ~(1ul << 31)) | ((1ul << 3) << (4 * u32ChannelNum));
    if(u32DutyCycle == 0)
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CMR[u32ChannelNum] = 0;
    else
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CMR[u32ChannelNum] = u32DutyCycle * (u16CNR + 1) / 100 - 1;
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CNR[u32ChannelNum] = u16CNR;
...
void PWM_Start (PWM_T *pwm, uint32_t u32ChannelMask)
{
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PCR |= u32Mask;
}
...
void PWM_Stop (PWM_T *pwm, uint32_t u32ChannelMask)
{
    ...
    for(i = 0; i < (6); i ++)
    {
        if(u32ChannelMask & (1 << i))
        {
            ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CNR[i] = 0;
        }
    }
...
void PWM_EnableADCTrigger (PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    if(u32ChannelNum < 4)
    {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGCON0 = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGCON0 & ~(((1ul << 3) |
                                          (1ul << 2) |
                                          (1ul << 1) |
                                          (1ul << 0) ) << (8 * u32ChannelNum))) | (u32Condition << (8 * u32ChannelNum));
    }
    else
    {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGCON1 = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGCON1 & ~(((1ul << 3) |
                                          (1ul << 2) |
                                          (1ul << 1) |
                                          (1ul << 0) ) << (8 * (u32ChannelNum - 4)))) | (u32Condition << (8 * (u32ChannelNum - 4)));
...
void PWM_ClearADCTriggerFlag (PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    if(u32ChannelNum < 4)
    {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGSTS0 |= (u32Condition << (8 * u32ChannelNum));
    }
    else
    {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGSTS1 |= (u32Condition << (8 * (u32ChannelNum - 4)));
    }
}
...
uint32_t PWM_GetADCTriggerFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ...
    if(u32ChannelNum < 4)
    {
        u32Ret = ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGSTS0 >> (8 * u32ChannelNum);
    }
    else
    {
        u32Ret = ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGSTS1 >> (8 * (u32ChannelNum - 4 ));
    }
...
void PWM_EnableFaultBrake (PWM_T *pwm,
                           ...
                           uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PFBCON = (u32LevelMask << 24) | u32BrakeSource;
}
...
void PWM_ClearFaultBrakeFlag (PWM_T *pwm, uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PFBCON = (1ul << 7);
}
...
void PWM_EnableOutput (PWM_T *pwm, uint32_t u32ChannelMask)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->POE |= u32ChannelMask;
}
...
void PWM_EnableDeadZone (PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Duration)
{
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PDZIR = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PDZIR & ~((0xFFul << 0) << (8 * u32ChannelNum))) | (u32Duration << (8 * u32ChannelNum));
    
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PCR |= ((1ul << 24) << u32ChannelNum);
}
...
void PWM_EnableDutyInt (PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32IntDutyType)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER |= ((1ul << 8) << u32ChannelNum);
}
...
void PWM_ClearDutyIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR = ((1ul << 8) << u32ChannelNum);
}
...
uint32_t PWM_GetDutyIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR & ((1ul << 8) << u32ChannelNum) ? 1 : 0);
}
...
void PWM_EnableFaultBrakeInt (PWM_T *pwm, uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER |= (1ul << 16);
}
...
void PWM_ClearFaultBrakeIntFlag (PWM_T *pwm, uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR = u32BrakeSource;
}
...
uint32_t PWM_GetFaultBrakeIntFlag (PWM_T *pwm, uint32_t u32BrakeSource)
{
    return (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR & u32BrakeSource ? 1 : 0);
}
...
void PWM_EnablePeriodInt (PWM_T *pwm, uint32_t u32ChannelNum,  uint32_t u32IntPeriodType)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER & ~(1ul << 17)) | ((1ul << 0) << u32ChannelNum) | u32IntPeriodType;
}
...
void PWM_DisablePeriodInt (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER &= ~((1ul << 0) << u32ChannelNum);
}
...
void PWM_ClearPeriodIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR = ((1ul << 0) << u32ChannelNum);
}
...
uint32_t PWM_GetPeriodIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR & ((1ul << 0) << u32ChannelNum) ? 1 : 0);
}
